...
export default function Footer() {
    return <footer className='pt-20 bg-white z-20' id='contact'>
        <div className=' container mx-auto mb-24'>
          ...
          className='flex flex-col lg:flex-row lg:justify-between gap-x-0
          gap-y-14'>
             ...
             <div className='flex-1'>
                ...
                <forum className='flex gap-x-2 h-14'>
                   <input type='text' placeholder='Your email' className=' outline-none
                    bg-white h-full border rounded-lg pl-4 focus: border-accent-default'/>
